...
Your response MUST be a JSON object containing a list of `ranked_tool_ids` for the best tools to use, in order of relevance.
Do not provide any explanation or extra text.

Example response:
{{
  "ranked_tool_ids": ["tool-id-1", "tool-id-2"]
}}